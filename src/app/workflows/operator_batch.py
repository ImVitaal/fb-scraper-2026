...
class OperatorBatchWorkflow:
    ...
    def __init__(
        ...
        *,
        ...
        self.raw_root = (raw_root or output).resolve()
        ...
        *,
        ...
        result = OperatorBatchRunResult(
            ...
            identifier_set_sha256=self._set_hash(
                sorted(
                    item.identifier_set_sha256 for item in succeeded if item.identifier_set_sha256
                )
            ),
    ...
    def _previous(self) -> dict[str, OperatorBatchGroupResult]:
        ...
        try:
            ...
            if not isinstance(groups, list):
                raise TypeError
            return {
                str(item["target_key"]): self._from_dict(item)
                for item in groups
    ...
    def _success(
        ...
        return OperatorBatchGroupResult(
            ...
            identifier_set_sha256=OperatorBatchWorkflow._set_hash(list(identifiers)),
    ...
    def _write_progress(self, groups: list[OperatorBatchGroupResult]) -> None:
